...
// Mark: get categories from firebase
...
func saveCategoryToFirebase(_ category: Category) {
    ...
    category.id = id
    FirebaseReference(.Category).document(id).setData(
        categoryDictionaryFrom(category) as! [String: Any]
    )
...
// Convert category to disctionary
...
// Used only once to save categories in firebase
// comment out after function was run
